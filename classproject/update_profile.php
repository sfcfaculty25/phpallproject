...
if(isset($_POST['edit']))
{
    ...
    $query_edit = " update user_register set fname='$fname', lname='$lname',username='$username', email='$email' where userid='$id' ";
 
    $check= mysqli_query($conn,$query_edit);
          ...
          <div class="media">
            ...
            <div class="media-body">
              ...
              <ul class="user-profile-list">
                ...
                <li><span>Full Name:</span> <input type="text" name="fname" value="<?php  echo $row['fname'] ?>"/> 
                <input type="text" name="lname" value="<?php  echo $row['lname'] ?>"/> 
            </li>
                <li><span>Country:</span>USA</li>
                <li><span>Email:</span><input type="text" name="email" value="<?php  echo $row['email'] ?>"/></li>
                <li><span>Username:</span> <input type="text" name="username" value="<?php  echo $row['username']?>"/> </li>
                <li><span>Date of Birth:</span>Dec , 22 ,1991</li>
                <li><input type="submit" name="edit" value="Update Profile" /></li>
              </ul>
</form>
            </div>
          </div>
